...
class InventarioRepository(
    ...
    /**
     * Busca un producto por nombre, usado cuando OpenAI Vision identifica
     * un producto por su nombre (texto libre) y necesitamos su productoId
     * real de Firebase para poder actualizar el stock.
     *
     * Hace match flexible (ignora mayúsculas/minúsculas y espacios extra)
     * porque OpenAI no siempre devuelve el nombre exacto carácter por carácter
     * como está guardado en /productos.
     *
     * Si hay varios productos que coinciden parcialmente, devuelve el de
     * coincidencia exacta (normalizada) si existe; si no, el primer match parcial.
     */
